              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    <Link href={`/conversation/${flag.conversation.id}`} className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                ...
                <div className="ml-4">
                  {flag.status === 'PENDING' && (
                    <button
                      onClick={() => { setRespondingTo(respondingTo === flag.id ? null : flag.id); setResponseText(''); }}
              ...
              {respondingTo === flag.id && (
                <div className="mt-3 border-t border-red-200 pt-3 dark:border-red-800">
                  ...
                  <div className="mt-2 flex justify-end gap-2">
                    <button onClick={() => { setRespondingTo(null); setResponseText(''); }} className="rounded-md px-3 py-1.5 text-xs text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800">
                      Cancel
                    </button>
                    <button
