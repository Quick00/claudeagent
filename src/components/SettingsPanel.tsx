  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <h3 className="mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">App Account</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">{session?.user?.email}</p>
        </div>

        <div className="border-t border-gray-200 pt-4 dark:border-gray-700">
          <h3 className="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">Claude Account</h3>
        ...
        <div className="border-t border-gray-200 pt-4 dark:border-gray-700">
          <h3 className="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">Appearance</h3>
